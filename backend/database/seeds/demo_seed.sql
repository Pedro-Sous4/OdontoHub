...
VALUES ('00000000-0000-0000-0000-000000000001','OdontoHub Cl�nica Demo','99888777000166','contato@odontohub.com')
...
VALUES
  ...
  ('20000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000001','Jo�o Pereira','12345678902','5511999992222','joao@exemplo.com','1988-09-21')
ON CONFLICT (id) DO UPDATE
SET nome = EXCLUDED.nome,
